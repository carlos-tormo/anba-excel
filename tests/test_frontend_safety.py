...
class FrontendSafetyTests(unittest.TestCase):
    ...
    def test_gm_attractiveness_admin_ranking_is_wired(self) -> None:
        ...
        self.assertIn("/api/admin/draft-history/selections/", admin)
        ...
        self.assertIn("draftHistorySelectionEditModal", admin)
        self.assertIn("data-draft-history-edit-id", admin)
        self.assertIn("Usar timeline por fecha/equipo", admin)
        self.assertIn("preserve_selecting_gm_override", admin)
    ...
    def test_player_happiness_import_frontend_is_wired(self) -> None:
        ...
        self.assertIn('id="playerHappinessImportMode"', admin_html)
        self.assertIn("Ledger histórico con recencia", admin_html)
        ...
        self.assertIn("/api/admin/player-happiness-ledger-import/preview", admin)
        self.assertIn("/api/admin/player-happiness-ledger-import/import", admin)
        self.assertIn("function renderPlayerHappinessImportPreview", admin)
        self.assertIn("function playerHappinessImportMode", admin)
