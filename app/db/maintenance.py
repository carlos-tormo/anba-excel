...
try:
    from .connection import ClosingSQLiteConnection, DatabaseConnectionMixin
    from .migrations import CURRENT_SCHEMA_MIGRATION_KEY, CURRENT_SCHEMA_VERSION, now_iso, row_to_dict
except ImportError:  # pragma: no cover - supports direct script execution.
    from db.connection import ClosingSQLiteConnection, DatabaseConnectionMixin
    from db.migrations import CURRENT_SCHEMA_MIGRATION_KEY, CURRENT_SCHEMA_VERSION, now_iso, row_to_dict
...
class DatabaseMaintenanceService:
    """Application-facing boundary for backup and maintenance infrastructure."""

    def __init__(self, maintenance: Any) -> None:
        self._maintenance = maintenance

    def status(self) -> Dict[str, Any]:
        return self._maintenance.maintenance_status()
